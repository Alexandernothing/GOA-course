/* 1. Congratulations! That Special Someone has given you their phone number.
...
function validateNumber(str){
  ...
  if(empty.slice(0, 2) === "07" && empty.length === 11) {
      return "In with a chance"
  }
  else if(empty.slice(0, 4) === "+447" && empty.length === 13) {
    return "In with a chance"
  }
...
console.log(validateNumber('0754876120'))
console.log(validateNumber('0745-487-61-20'))
console.log(validateNumber('+447535514555'))